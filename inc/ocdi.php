...
add_action('admin_head', 'lenity_admin_head');
function lenity_admin_head() {
  echo '<style>
...
function lenity_ocdi_before_content_import( $selected_import ) {
...
add_action( 'ocdi/before_content_import', 'lenity_ocdi_before_content_import' );

function lenity_ocdi_plugin_intro_text( $default_text ) {
...
add_filter( 'ocdi/plugin_intro_text', 'lenity_ocdi_plugin_intro_text' );

function lenity_ocdi_import_files() {
  return array(
    array(
      'import_file_name'           => 'Demo',
      'import_file_url'            => 'https://cdn.awaikenthemes.com/demo-content/lenity/lenity.xml',
      'import_customizer_file_url' => 'https://cdn.awaikenthemes.com/demo-content/lenity/lenity.dat',
	  'import_preview_image_url'   => 'https://demo.awaikenthemes.com/lenity/assets/demo.jpg',
      'preview_url'                => 'https://demo.awaikenthemes.com/lenity/',
    )
  );
}
add_filter( 'ocdi/import_files', 'lenity_ocdi_import_files' );


function lenity_ocdi_after_import_setup() {
	
	// Assign menus to their locations.
	$header_menu = get_term_by( 'name', 'Header Menu', 'nav_menu' );
	$footer_menu = get_term_by( 'name', 'Footer Menu', 'nav_menu' );
	update_option( 'lenity_demo_imported', 1, 'no' );
...
add_action( 'ocdi/after_import', 'lenity_ocdi_after_import_setup' );